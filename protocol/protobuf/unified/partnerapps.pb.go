...
func (*CPartnerApps_FinishUploadDepot_Response) Descriptor() ([]byte, []int) {
	return partnerapps_fileDescriptor0, []int{8}
}
...
func (*CPartnerApps_GetDepotBuildResult_Response) Descriptor() ([]byte, []int) {
	return partnerapps_fileDescriptor0, []int{10}
}
...
func (*CPartnerApps_FindDRMUploads_Request) Descriptor() ([]byte, []int) {
	return partnerapps_fileDescriptor0, []int{11}
}
...
func (*CPartnerApps_ExistingDRMUpload) Descriptor() ([]byte, []int) { return partnerapps_fileDescriptor0, []int{12} }
...
func (*CPartnerApps_FindDRMUploads_Response) Descriptor() ([]byte, []int) {
	return partnerapps_fileDescriptor0, []int{13}
}
...
func (*CPartnerApps_Download_Request) Descriptor() ([]byte, []int) { return partnerapps_fileDescriptor0, []int{14} }
...
func (*CPartnerApps_Download_Response) Descriptor() ([]byte, []int) { return partnerapps_fileDescriptor0, []int{15} }
